...
import common_method.Get_common_method_api;
...
public class get_tc {
	...
	public static void orchestrator() throws IOException
	{
		...
		for (int i=0; i<5; i++)
		{
			responseStatuscode = Get_common_method_api.responsestatus_extractor(baseuri, resource);
			if (responseStatuscode == 200)
			{
				responseBody = Get_common_method_api.reponsebody_extractor(baseuri, resource);
		...
		common_method_api.evidanceFileCreator("get_tc", resource, responseBody);
